...
//criando o sprite do jogador
    player = createSprite(displayWidth-displayWidth+100, displayHeight-300, 50, 50);
...
BossGroup.overlap(bulletGroup,(alienboss,bullet)=>{
  bullet.destroy()
  bossLife -=1
...
// text('Boss: '+ bossLife,displayWidth/3-350,displayHeight/2-255)
...
function StarsGenerator(){
  if(frameCount%400===0){
  star = createSprite(width,height/2,40,40)
  star.addImage('star',starImg)
  star.scale = 0.13
  star.velocityX = -25
  star.velocityY = random(-5,5)
  starGroup.add(star)
